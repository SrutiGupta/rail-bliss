...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "RailYatra — Book Railway Tickets Online" },
      {
        name: "description",
        content:
          "Search trains between stations, check seat availability, book confirmed tickets with instant PNR, and cancel online.",
      },
      { property: "og:title", content: "RailYatra — Book Railway Tickets Online" },
      {
        property: "og:description",
        content: "Train search, seat availability, instant PNR booking and cancellation.",
      },
    ],
  }),
  component: Index,
